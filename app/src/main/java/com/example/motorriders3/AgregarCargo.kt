...
class AgregarCargo : AppCompatActivity() {
    var etId: EditText?=null
    var etNombre: EditText?=null

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_agregar_cargo)
    ...
    fun Guardar(Vista: View){
        ...
        var resultadoPost = object: StringRequest(Request.Method.POST,url,
            Response.Listener<String> { respuesta ->
                Toast.makeText(this, "Cargo insertado exitosamente", Toast.LENGTH_LONG).show()
                etNombre?.setText("")
            ...
            override fun getParams(): MutableMap<String,String> {
                ...
                parametro.put("nomCargo", etNombre?.text.toString())
